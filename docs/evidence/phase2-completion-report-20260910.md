...
failure rows. Thirty-eight rows have executable evidence: the browser cases (`P2-F001`,
`P2-F003`, `P2-F004`, `P2-F005`, `P2-F007`, `P2-F010`, `P2-F011`, `P2-F017`,
`P2-F022`, `P2-F031`, `P2-F073`, and `P2-F075`) plus named Rust
...
schema repair with Phase 1 byte retention, and legacy active-state refusal. The other 42 remain
...
failure matrix has 80 rows. The row-level ledger records 38 executed cases and 42
