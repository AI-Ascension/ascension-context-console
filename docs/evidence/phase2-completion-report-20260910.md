...
failure rows. Thirty-nine rows have executable evidence: the browser cases (`P2-F001`,
...
for `P2-F064`. The other 41 remain
...
failure matrix has 80 rows. The row-level ledger records 39 executed cases and 41
